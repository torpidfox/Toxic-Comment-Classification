...
Данные передобрабатываются с помощью стандартных процедур, таких как стемминг, выявление ключевых слов и анализ частоты их употребления. Ядро приложения основывается на байесовской фильтрации в сочетании с реккурентной нейронной сетью.
